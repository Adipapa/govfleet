        ...
        <div className="flex items-center space-x-2">
          <button
            ...
            className={`flex items-center space-x-1.5 px-3 py-1.5 rounded-lg text-xs font-semibold border transition-colors ${
              soundEnabled ? 'bg-red-950 text-red-300 border-red-700' : 'bg-slate-100 text-slate-500 border-slate-700'
            }`}
          >
                ...
                <div className="flex flex-col md:flex-row md:items-start justify-between gap-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <div className="flex flex-wrap items-center gap-2">
                        <span className="font-bold text-sm text-slate-900 tracking-tight">{alt.title}</span>
                        <span className="font-mono text-xs px-2 py-0.5 rounded bg-slate-100 text-cyan-300 border border-slate-700">
                          {alt.vehicleReg}
                        </span>
                        <span className="text-xs text-slate-500">({alt.department})</span>
                  ...
                  <div className="flex flex-wrap items-center gap-2 shrink-0 self-end md:self-start">
                    <button
                      ...
                      className="px-3 py-1.5 bg-slate-100 hover:bg-slate-700 text-slate-700 rounded-lg text-xs font-semibold flex items-center space-x-1.5 transition-colors cursor-pointer"
                    >
                      <MapPin className="w-3.5 h-3.5 text-cyan-400" />
                    ...
                    {!alt.dispatchedToPolice && (
                      <button
                        ...
                        className="px-3 py-1.5 bg-blue-600 hover:bg-blue-500 text-slate-900 rounded-lg text-xs font-bold flex items-center space-x-1.5 transition-colors shadow-lg cursor-pointer"
                      >
